...
- Используемая версия Python - 3.9. Убедитесь, что вы используете соответствующую версию TF-Lite. Для Tensorflow 2.7.0 ссылка на необходимый пакет: https://github.com/MukhamejanKaratayev/hw-serverless-lambda/blob/main/tflite_runtime-2.7.0-cp39-cp39-linux_x86_64.whl или https://drive.google.com/file/d/1aasmfUtgpyN2ACuZeZ3hhfkzDAmrkU1R/view?usp=sharing
